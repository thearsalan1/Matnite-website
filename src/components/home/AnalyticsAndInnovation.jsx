...
const Analytics = () => {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-10 py-20 px-5 md:px-10 ">
      {/* LEFT SECTION */}
      <section className="w-full lg:w-1/2 p-8 bg-white rounded-3xl  flex flex-col items-center gap-6 relative overflow-hidden shadow-green-500 shadow-md hover:shadow-lg text-gray-700">
        {/* subtle glow */}
      ...
      <section className="w-full lg:w-1/2 p-8 bg-white rounded-3xl shadow-md hover:shadow-lg relative overflow-hidden shadow-blue-500">
        {/* Badge */}
        ...
        {/* Heading */}
        <h1 className="text-3xl md:text-4xl font-bold text-center font-heading mb-4 text-gray-700">
          Intelligent Innovations
        </h1>

        <p className="text-gray-600 text-center mb-8">
          Extend your platform with{" "}
          <span className="matRed">purpose-built AI</span> and{" "}
          <span className="matGreen">automation products</span>.
        </p>
